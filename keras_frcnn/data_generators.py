    ...
    while True:
        ...
        for img_data in all_img_data:
            try:
                ...
                # https://opencv-python.readthedocs.io/en/latest/doc/10.imageTransformation/imageTransformation.html#scaling
                # INTER_CUBIC은 느리고 이미지 확대를 위해서 하는 것인데 왜 이미지를 확대하는 것일까? 원본 이미지 사이즈는 얼마?
                # 600 보다는 대부분 작다고 함, 하긴 줄이면 정보가 날라갈 수 있으니 리사이즈를 먼저해놓고 하면 training이 더 빨라질 수 있을 것 같음)
                ...
                # resize/augmented/preprocessing 된 이미지와 rpn에서 계산된 영역/class 등의 정보를 만들어줌
